...
for t in $@; do
  ...
  echo "=== ${t} ==="
  if [ -e "/Users/andonmitev/Desktop/RUst/hello_world/target/rls/debug/build/jemalloc-sys-d2251fbb9019ee0a/out/jemalloc/${t}.sh" ] ; then
    ...
    enable_fill=1 \
    enable_prof=0 \
    . /Users/andonmitev/Desktop/RUst/hello_world/target/rls/debug/build/jemalloc-sys-d2251fbb9019ee0a/out/jemalloc/${t}.sh && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /Users/andonmitev/Desktop/RUst/hello_world/target/rls/debug/build/jemalloc-sys-d2251fbb9019ee0a/out/jemalloc/ /Users/andonmitev/Desktop/RUst/hello_world/target/rls/debug/build/jemalloc-sys-d2251fbb9019ee0a/out/build/
  else
    export MALLOC_CONF= && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /Users/andonmitev/Desktop/RUst/hello_world/target/rls/debug/build/jemalloc-sys-d2251fbb9019ee0a/out/jemalloc/ /Users/andonmitev/Desktop/RUst/hello_world/target/rls/debug/build/jemalloc-sys-d2251fbb9019ee0a/out/build/
